...
--
-- Adds the schema that the CP<->Gateway mTLS plane needs (Design §2A,
...
-- Stores the token HASH only. Minted by Authorization.Authorize from the RBAC
-- decision on ALLOW (VERSIONING.md §6).
