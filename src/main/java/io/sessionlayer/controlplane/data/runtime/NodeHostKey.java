 ...
 * identity so inner-leg host verification is <b>never TOFU</b>:
 * {@code hostCertRef} (host-CA-signed host cert) is the primary anchor,
 * {@code publicKey}/{@code fingerprint} the pinned-key fallback. Public
 * material only.
 */
