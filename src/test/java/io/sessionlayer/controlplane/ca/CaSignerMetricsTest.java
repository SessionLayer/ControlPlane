...
/**
 * When no active CA of the requested kind exists, {@code activeSigner}
...
class CaSignerMetricsTest {
	...
	void noActiveSignerFailsClosedAndIsMeasuredUnavailable() {
		...
		// A real request is measured under source=request (the availability SLI population).
